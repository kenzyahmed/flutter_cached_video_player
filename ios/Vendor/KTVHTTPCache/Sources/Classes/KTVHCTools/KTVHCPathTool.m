...
+ (NSString *)basePath
{
    // Caches, not Documents: the files here are re-downloadable media. iOS backs
    // Documents up to iCloud and never purges it under storage pressure, and
    // Apple's data storage guidelines keep re-downloadable data out of it.
