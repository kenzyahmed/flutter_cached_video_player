...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
  ...
  private ReelCache reelCache;
  private io.flutter.plugin.common.MethodChannel reelCacheChannel;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    reelCache = new ReelCache(binding.getApplicationContext());
    reelCacheChannel = new io.flutter.plugin.common.MethodChannel(
        binding.getBinaryMessenger(), "suiiz/reel_cache");
    reelCacheChannel.setMethodCallHandler(reelCache::handle);
  ...
  public void onDetachedFromEngine(@NonNull FlutterPluginBinding binding) {
    ...
    reelCacheChannel.setMethodCallHandler(null);
    reelCache.close();
